<template>
  <div class="markdown-con">
    <div class="showMarkDown-div">
      <router-link
        :to="{ name: 'MarkDownDynRouting', params: { id: showMarkDown.id } }"
...
export default {
	...
	setup() {
		...
		metaDescription.content =
			"This is the page that forms part of the home page, in this particular page, a user uses the markdown to create contents in the application.";
